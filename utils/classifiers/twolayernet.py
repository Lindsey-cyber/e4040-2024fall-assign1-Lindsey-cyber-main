...
class TwoLayerNet(object):
    ...
    def forward(self, X):
        ...
        from ..layer_funcs import affine_forward, relu_forward, tanh_forward
        X = affine_forward(relu_forward(affine_forward(X, self.layer1.params['W'], self.layer1.params['b'])), self.layer2.params['W'], self.layer2.params['b'])
